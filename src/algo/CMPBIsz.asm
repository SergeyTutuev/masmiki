...
; [bp+20]  - FirstOffset      ; смещение первого числа
; [bp+22]  - FirstSeg         ; сегмент первого числа
; [bp+24] - SecondOffset     ; смещение второго числа
; [bp+26] - SecondSegment    ; сегмент второго числа
