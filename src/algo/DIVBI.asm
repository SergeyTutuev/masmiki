...
; [bp+6]  - BIOffset1  ; смещение делимого
; [bp+8]  - BISeg1     ; сегмент делимого
; [bp+10] - BIOffset2  ; смещение делителя
; [bp+12] - BISeg2     ; сегмент делителя
; [bp+14] - BIOffset3  ; смещение результата (частного)
; [bp+16] - BISeg3     ; сегмент результата (частного)
DivideBigInt PROC FAR USES ds es si di bx cx dx BIOffset1:WORD, BISeg1:WORD, BIOffset2:WORD, BISeg2:WORD, BIOffset3:WORD, BISeg3:WORD
		push ax
