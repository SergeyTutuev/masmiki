...
SHR_CODE SEGMENT READONLY PUBLIC 'CODE'
public ShrBigInt

; Процедура логического сдвига вправо для больших чисел
; [bp+6]  = offset source (BigInt)
; [bp+8]  = segment source
; [bp+10] = bitCount (количество бит для сдвига)
; [bp+12] = offset result (BigInt) 
; [bp+14] = segment result
ShrBigInt PROC FAR uses ax bx cx dx si di es ds FirstOffset:WORD, FirstSeg:WORD, BitCount:WORD, SecondOffset:WORD, SecondSegment:WORD
