...
.data
	...
	shift_right db 02
	correct_number db 00000000b, 00000001b, 00011110b, 01011111b
	...
	msg1 db 'TestShrBigIntCase1 passed',13,10,'$',0
	msg2 db 'TestShrBigIntCase1 FAILED',13,10,'$',0


.CODE
public TestShrBigIntCase1
TestShrBigIntCase1 proc far uses si
	mov ax, @data
	mov ds, ax
	mov es, ax
